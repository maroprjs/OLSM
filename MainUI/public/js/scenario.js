...
ready(() => {
    ...
    ioSocket.on('omron_pic', function (data) { //data = video source
        console.log(data);
        /*if (data === "inspection_pic_01") {
            document.getElementById("picRobot").src = "pics/pic1.jpg";
            document.getElementById("picRobot").style.display = "block";
            setTimeout(function () {
                document.getElementById("picRobot").style.display = "none"
            }, 4000);
        };
        if (data === "inspection_pic_02") {
            document.getElementById("picRobot").src = "pics/pic2.jpg";
            document.getElementById("picRobot").style.display = "block";
            setTimeout(function () {
                document.getElementById("picRobot").style.display = "none"
            }, 4000);
        };
        if (data === "inspection_pic_03") {
            document.getElementById("picRobot").src = "pics/pic3.jpg";
            document.getElementById("picRobot").style.display = "block";
            setTimeout(function () {
                document.getElementById("picRobot").style.display = "none"
            }, 4000);
        };
        if (data === "inspection_pic_04") {
            document.getElementById("picRobot").src = "pics/pic4.jpg";
            document.getElementById("picRobot").style.display = "block"
            setTimeout(function () {
                document.getElementById("picRobot").style.display = "none";
            }, 4000);
        };*/
        //= inspection_pic_01 inspection_pic_02 inspection_pic_03 inspection_pic_04
    });
